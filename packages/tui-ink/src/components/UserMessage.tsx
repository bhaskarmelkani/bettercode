...
export const UserMessage = React.memo(function UserMessage({ parts, isQueued, tone }: Props) {
  ...
  const border = tone === "cursor" ? theme.cyan : tone === "search" ? theme.yellow : theme.cyan
